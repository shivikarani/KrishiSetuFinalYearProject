# Generated by Django 5.2.6 on 2026-02-19 15:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crop', models.CharField(max_length=100)),
                ('status', models.CharField(choices=[('submitted', 'Submitted'), ('assigned', 'Assigned'), ('review', 'In Review'), ('responded', 'Responded'), ('closed', 'Closed')], default='submitted', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_response', models.FileField(blank=True, null=True, upload_to='responses/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='media', to='core.query')),
            ],
        ),
    ]
